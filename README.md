...
| Web             | `apps/web: npm run test:coverage`        | 37 files, **297** tests   | stmts 99.29% (703/708) · branches 97.16% (515/530) · funcs 100% (224/224) · lines 99.27% (687/692) | 90% on all four            |

**1252 tests, 0 failures.** From the root, `npm test`, `npm run lint`,
