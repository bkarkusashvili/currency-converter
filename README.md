...
| Web             | `apps/web: npm run test:coverage`        | 40 files, **357** tests   | stmts 98.99% (988/998) · branches 96.11% (814/846) · funcs 99.67% (308/309) · lines 98.97% (964/974) | 90% on all four            |

**1312 tests, 0 failures.** From the root, `npm test`, `npm run lint`,
