...
import { RatesArchiveIndexes } from '../rates-archive-indexes.provider';
...
describe('RatesArchiveIndexes', () => {
  ...
  it('reconciles the indexes once the connection is open', async () => {
    ...
    expect(logger.info).toHaveBeenCalledWith(
      'Rate snapshot archive indexes are in place',
    );
  });
